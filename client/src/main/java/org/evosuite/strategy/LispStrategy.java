...
import org.evosuite.testcase.LispChromosomeFactory;
...
public class LispStrategy extends TestGenerationStrategy {

	private static final Logger logger = LoggerFactory.getLogger(LispStrategy.class);
